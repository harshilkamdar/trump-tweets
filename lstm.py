...
for iteration in range(1, epochs):
    ...
    if iteration % 10 == 0:
        ...
        open('model.txt', 'w').write(json_string)
        model.save_weights('model.h5', overwrite=True)

    if print_after_each_iter:
        ...
        for diversity in [0.2, 0.5, 1.0, 1.2]:
            ...
            for iteration in range(out_chars):
        ...
        print('Training completed for epoch %f' % iteration)
